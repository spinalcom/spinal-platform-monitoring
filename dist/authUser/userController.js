...
let UsersController = class UsersController extends tsoa_1.Controller {
    ...
    updateAuthAdmin(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            return new userService_1.UserService().updateAuthAdmin(requestBody);
        });
    }
    // @Security('jwt')
    getAuthAdmin() {
        return __awaiter(this, void 0, void 0, function* () {
            return new userService_1.UserService().getAuthAdmin();
        });
    }
    userProfilesList() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    loginAuthAdmin(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            this.setStatus(201); // set return status 201
            return new userService_1.UserService().loginAuthAdmin(requestBody);
        });
    }
    // @Security("jwt")
...
__decorate([
    ...
    (0, tsoa_1.Put)(),
    __param(0, (0, tsoa_1.Body)())
], UsersController.prototype, "updateAuthAdmin", null);
__decorate([
    (0, tsoa_1.Post)('/getAuthAdmin')
], UsersController.prototype, "getAuthAdmin", null);
__decorate([
    (0, tsoa_1.Security)('jwt'),
...
__decorate([
    (0, tsoa_1.Post)('/loginAuthAdmin'),
    __param(0, (0, tsoa_1.Body)())
], UsersController.prototype, "loginAuthAdmin", null);
__decorate([
